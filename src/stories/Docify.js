...
function Viewer(props) {
    ...
    return <Card className={[classes.cardV, classes.viewer]} variant="outlined">
        <Container>
            {data}
        </Container>
    </Card>
    ...
    return (
        <Timeline align="left">
            ...
            <TimelineItem>
                ...
                <TimelineContent><div style={{ width: '200px' }}>Code</div></TimelineContent>
            </TimelineItem>
            <TimelineItem>
                <TimelineSeparator>
                    <TimelineDot />
                ...
                <TimelineContent><div style={{ width: '200px' }}>Description</div></TimelineContent>
            </TimelineItem>
            <TimelineItem>
                <TimelineSeparator>
                    <TimelineDot />
                </TimelineSeparator>
                <TimelineContent><div style={{ width: '200px' }}>Props Table</div></TimelineContent>
            </TimelineItem>
        </Timeline>
    );
}
